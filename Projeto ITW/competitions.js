       ...
       $().ready(function () {
        $("#tagsCompetitions").autocomplete({
            ...
            select: function (event, ui) {
                window.location.href = "competitionsDetails.html?id=" + ui.item.name;
            },
        ...
        $('#searchform').submit(function(event) {
            ...
            let competitionID = $('#tagsCompetitions').val();
            // redirect to the athlete's page using the athlete ID
            if (isValidID(competitionID)) {
            window.location.href = "competitionsDetails.html?id=" + competitionID;
            } else {
